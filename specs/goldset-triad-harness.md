...
*Generated by `verify_subject_index.py` against the actual section membership, not written by hand — an index
asserted from memory is worse than none, because a missing row actively misdirects a sweep. It **errs toward
over-inclusion**: a spurious "check here" costs a glance, a missing one costs a contradiction.*
...
| Price & materiality | ubiquitous · event-driven |
...
| Ground-truth artifacts | ubiquitous · event-driven · unwanted behavior |
| Isolation | non-functional · unwanted behavior |
| Generation | ubiquitous · event-driven · optional feature |
